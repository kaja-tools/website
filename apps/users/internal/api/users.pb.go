...
const file_proto_users_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x05.UserR\x04user\"7\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x05.UserR\x05users\"\x17\n" +
	...
	"\n" +
	"DeleteUser\x12\x12.DeleteUserRequest\x1a\x13.DeleteUserResponse\x128\n" +
	"\vGetAllUsers\x12\x13.GetAllUsersRequest\x1a\x14.GetAllUsersResponse\x12A\n" +
