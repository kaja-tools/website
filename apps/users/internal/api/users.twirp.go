...
func (c *usersProtobufClient) DeleteAllUsers(ctx context.Context, in *DeleteAllUsersRequest) (*DeleteAllUsersResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "Users")
	ctx = ctxsetters.WithMethodName(ctx, "DeleteAllUsers")
	caller := c.callDeleteAllUsers
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *DeleteAllUsersRequest) (*DeleteAllUsersResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*DeleteAllUsersRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*DeleteAllUsersRequest) when calling interceptor")
					}
					return c.callDeleteAllUsers(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*DeleteAllUsersResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*DeleteAllUsersResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *usersProtobufClient) callDeleteAllUsers(ctx context.Context, in *DeleteAllUsersRequest) (*DeleteAllUsersResponse, error) {
...
func (c *usersJSONClient) DeleteAllUsers(ctx context.Context, in *DeleteAllUsersRequest) (*DeleteAllUsersResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "Users")
	ctx = ctxsetters.WithMethodName(ctx, "DeleteAllUsers")
	caller := c.callDeleteAllUsers
...
func (c *usersJSONClient) callDeleteAllUsers(ctx context.Context, in *DeleteAllUsersRequest) (*DeleteAllUsersResponse, error) {
	out := new(DeleteAllUsersResponse)
...
const UsersPathPrefix = "/twirp/Users/"
...
func (s *usersServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "GetAllUsers":
		...
		return
	case "DeleteAllUsers":
		s.serveDeleteAllUsers(ctx, resp, req)
		return
	default:
		msg := fmt.Sprintf("no handler for path %q", req.URL.Path)
		s.writeError(ctx, resp, badRouteError(msg, req.Method, req.URL.Path))
...
func (s *usersServer) serveDeleteAllUsers(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveDeleteAllUsersJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveDeleteAllUsersProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *usersServer) serveDeleteAllUsersJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteAllUsers")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(DeleteAllUsersRequest)
	unmarshaler := protojson.UnmarshalOptions{DiscardUnknown: true}
	if err = unmarshaler.Unmarshal(rawReqBody, reqContent); err != nil {
		s.handleRequestBodyError(ctx, resp, "the json request could not be decoded", err)
		return
	...
	handler := s.Users.DeleteAllUsers
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *DeleteAllUsersRequest) (*DeleteAllUsersResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*DeleteAllUsersRequest)
					if !ok {
					...
					return s.Users.DeleteAllUsers(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*DeleteAllUsersResponse)
	...
	// Call service method
	var respContent *DeleteAllUsersResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = handler(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *DeleteAllUsersResponse and nil error while calling DeleteAllUsers. nil responses are not supported"))
		return
	}
...
func (s *usersServer) serveDeleteAllUsersProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "DeleteAllUsers")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *usersServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "", "Users")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
