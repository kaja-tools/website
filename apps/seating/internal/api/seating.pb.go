...
func (x *HoldSeatsRequest) GetShowId() string {
	if x != nil {
		return x.ShowId
	}
	return ""
...
func (x *ConfirmSeatsResponse) Reset() {
	*x = ConfirmSeatsResponse{}
	mi := &file_proto_seating_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfirmSeatsResponse) Descriptor() ([]byte, []int) {
	return file_proto_seating_proto_rawDescGZIP(), []int{11}
}
...
func (x *WatchSeatsRequest) Reset() {
	*x = WatchSeatsRequest{}
	mi := &file_proto_seating_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchSeatsRequest) Descriptor() ([]byte, []int) {
	return file_proto_seating_proto_rawDescGZIP(), []int{12}
}
...
func (x *SeatUpdate) Reset() {
	*x = SeatUpdate{}
	mi := &file_proto_seating_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SeatUpdate) Descriptor() ([]byte, []int) {
	return file_proto_seating_proto_rawDescGZIP(), []int{13}
}
...
const file_proto_seating_proto_rawDesc = "" +
	...
	"\n" +
	"changed_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tchangedAt\"\xb1\x01\n" +
	"\x04Hold\x12\x0e\n" +
	...
	"\x14CHANGE_REASON_EXPIRE\x10\x042\xa2\x02\n" +
	"\aSeating\x12E\n" +
	"\n" +
	...
	"\fConfirmSeats\x12\x1c.seating.ConfirmSeatsRequest\x1a\x1d.seating.ConfirmSeatsResponse\x12?\n" +
	"\n" +
...
var file_proto_seating_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_proto_seating_proto_goTypes = []any{
	...
	(*WatchSeatsRequest)(nil),     // 15: seating.WatchSeatsRequest
	(*SeatUpdate)(nil),            // 16: seating.SeatUpdate
	nil,                           // 17: seating.SeatMap.AvailableBySectionEntry
...
var file_proto_seating_proto_depIdxs = []int32{
	...
	17, // 6: seating.SeatMap.available_by_section:type_name -> seating.SeatMap.AvailableBySectionEntry
	0,  // 7: seating.SeatChange.status:type_name -> seating.SeatStatus
	2,  // 8: seating.SeatChange.reason:type_name -> seating.ChangeReason
	18, // 9: seating.SeatChange.changed_at:type_name -> google.protobuf.Timestamp
	18, // 10: seating.Hold.expires_at:type_name -> google.protobuf.Timestamp
	...
	9,  // 16: seating.Seating.GetSeatMap:input_type -> seating.GetSeatMapRequest
	11, // 17: seating.Seating.HoldSeats:input_type -> seating.HoldSeatsRequest
	13, // 18: seating.Seating.ConfirmSeats:input_type -> seating.ConfirmSeatsRequest
	15, // 19: seating.Seating.WatchSeats:input_type -> seating.WatchSeatsRequest
	10, // 20: seating.Seating.GetSeatMap:output_type -> seating.GetSeatMapResponse
	12, // 21: seating.Seating.HoldSeats:output_type -> seating.HoldSeatsResponse
	14, // 22: seating.Seating.ConfirmSeats:output_type -> seating.ConfirmSeatsResponse
	16, // 23: seating.Seating.WatchSeats:output_type -> seating.SeatUpdate
...
func file_proto_seating_proto_init() {
	...
	file_proto_seating_proto_msgTypes[13].OneofWrappers = []any{
