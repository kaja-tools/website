...
const file_proto_teams_proto_rawDesc = "" +
	"\n" +
	"\x11proto/teams.proto\x12\x05teams\"F\n" +
	"\n" +
	"TeamMember\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1f\n" +
	"\x04role\x18\x02 \x01(\x0e2\v.teams.RoleR\x04role\"v\n" +
	"\x04Team\x12\x0e\n" +
	...
	"\x12DeleteTeamResponse\"\x14\n" +
	"\x12GetAllTeamsRequest\"8\n" +
	"\x13GetAllTeamsResponse\x12!\n" +
	"\x05teams\x18\x01 \x03(\v2\v.teams.TeamR\x05teams\"i\n" +
	...
	"\x1cUpdateTeamMemberRoleResponse*9\n" +
	"\x04Role\x12\x10\n" +
	...
	"\x05Teams\x12A\n" +
	"\n" +
	"CreateTeam\x12\x18.teams.CreateTeamRequest\x1a\x19.teams.CreateTeamResponse\x128\n" +
	"\aGetTeam\x12\x15.teams.GetTeamRequest\x1a\x16.teams.GetTeamResponse\x12A\n" +
	"\n" +
	"DeleteTeam\x12\x18.teams.DeleteTeamRequest\x1a\x19.teams.DeleteTeamResponse\x12D\n" +
	"\vGetAllTeams\x12\x19.teams.GetAllTeamsRequest\x1a\x1a.teams.GetAllTeamsResponse\x12J\n" +
